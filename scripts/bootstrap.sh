...
for role in run.admin iam.serviceAccount{Admin,TokenCreator,User} resourcemanager.projectIamAdmin compute.{loadBalancer,network,security}Admin firebaseauth.admin datastore.user; do
